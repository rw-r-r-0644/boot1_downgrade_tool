...
typedef struct
{
	...
	u32 nand_bank;
	u32 checksum;
} PACKED seeprom_hw_params_t;

_Static_assert(sizeof(seeprom_hw_params_t) == 0x10, "SEEPROM hw params size must be 0x10!");
...
typedef struct
{
	...
	u8 empty[8];
	u32 checksum;
} PACKED seeprom_boot1_params_t;

_Static_assert(sizeof(seeprom_boot1_params_t) == 0x10, "SEEPROM boot1 params size must be 0x10!");
...
typedef struct
{
    ...
    seeprom_hw_params_t hw_params;

    seeprom_boot1_params_t boot1_params[2];
